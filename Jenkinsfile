pipeline {
    ...
    environment {
        registry = "anpaezros/geekshubs-django"
            ...
            steps{
                script {
                    withCredentials([usernamePassword(credentialsId: 'Git-Encoded', usernameVariable: 'username', passwordVariable: 'password')]){
                        ...
                        sh "git clone https://$username:$password@github.com/anpaez/geekshub-django-deployment.git"
                        dir("geekshub-django-deployment") {
                            ...
                            sh "git push https://$username:$password@github.com/anpaez/geekshub-django-deployment.git"
                        }
                    }
                }
            }
